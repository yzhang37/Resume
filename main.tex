...
\begin{center}
    \textbf{\huge \scshape Zhenghang (John) Yin} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:+16176859135}{+1 (617)-685-9135}
    $|$
    \faAt \hspace{.5pt} \href{mailto:johnyin@bu.edu}{johnyin@bu.edu}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/zhenghangyin}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/yzhang37}{GitHub}
    % $|$
    % \faGlobe \hspace{.5pt} \href{https://arasgungore.github.io}{Portfolio}
    $|$
    \faMapMarker \hspace{.5pt} \href{https://www.google.com/maps/place/Wollaston/@42.2676176,-71.0229068,12z}{Boston, Massachusetts}
\end{center}
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      }{\href{https://www.google.com/maps/place/Graduate+School+of+Arts+and+Sciences/@42.3499883,-71.1048875,19.56z}{Boston, MA}}
      {MS in Artificial Intelligence;   \textbf{GPA: 3.4/4.0}}{Sep.\,2020 \textbf{--} Dec.\,2022 (Expected)}
        \resumeItemListStart
            \resumeItem{\textbf{Coursework Taken:} Deep Learning, Machine Learning, Natural Language Processing, Tools for Data Science, Grad Networking, Grad Computer Graphics, Grad Algorithms, Grad Database System, Object-oriented Software}
        \resumeItemListEnd
    \resumeSubheading
      {East China Normal University
      % \normalfont{(Admission rate: 0.85\%)}
      }{\href{https://www.google.com/maps/place/华东师范大学/@31.227667,121.4042487,17z}{Shanghai, China}}
      {BE in Computer Science; \textbf{GPA: 3.43/4.0} \normalfont{(top 20\%)}}{Sep.\,2014 \textbf{--} Jul.\,2018}
        \resumeItemListStart
            \resumeItem{Excellent graduation thesis prize (top 5\%).}
            \resumeItem{Academic Scholarship: 2nd prize in 2015(top 10\%), 3rd prize in 2016(top  20\%).}
            \resumeItem{Microsoft Research Asia (MSRA)’s Beauty of Programming (BOP) 2016 (36/200, top 20\%).}
            \resumeItem{China Collegiate Algorithm Contest 2015, Bronze prize.}
        \resumeItemListEnd
...
\section{Work Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {wol.ai Note $|$ \emph{\href{https://wol.ai/}{\color{blue}Website}}}{Shanghai, China}
      {SDE}{Jan.\,2021 \textbf{--} Aug.\,2021}
        \resumeItemListStart
            \resumeItem{Developed React.js + Typescript Web and mobile frontend.}
            \resumeItem{Developed Backend using TS, Golang and Serverless. Engaged in \textgreater 80\% of wol.ai's Import/Export functions.}
            \resumeItem{Patent on solving the filename encoding recognition inside ZIP file. (China Patent No.: CN114580353A)}
        \resumeItemListEnd
    
    \resumeSubheading
      {AI Lab, Qiniu Limited}{Shanghai, China}
      {Algorithm Engineer}{Apr.\,2018 \textbf{--} May.\,2019}
        \resumeItemListStart
